      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              >
                ...
                <dd
                  ...
                  @click="changeChecked(saleAttr.spuSaleAttrValueList,saleAttrValue)"
                 >
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model = "skunum" @keyup = "skunum = skunum.replace(/^(0+)|[^\d]+/g,'')">
                <a href="javascript:" class="plus" @click="skunum++">+</a>
                <a href="javascript:" class="mins" @click="skunum>1 ?skunum--:skunum=1">-</a>
              </div>
              <div class="add" @click="AddCart(skunum,skuInfo.id)">
...
import { mapGetters } from "vuex";
  ...
  export default {
    ...
    mounted(){
      ...
      this.$store.dispatch('getGoodsList',skuId)
   },
   computed:{
  ...
  methods:{
    changeChecked(spuSaleAttrValueList,saleAttrValue){
      console.log('spuSaleAttrValueList',spuSaleAttrValueList,'saleAttrValue',saleAttrValue)
