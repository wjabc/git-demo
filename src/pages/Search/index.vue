    ...
    <div>
        ...
        <div class="main">
            ...
            <div class="py-container">
                ...
                <div class="bread">
                    ...
                    <ul class="fl sui-tag">    
                      ...
                      <!-- <li class="with-x" v-show="searchParams.trademark">
                       ...
                       <!-- 属性的面包屑 -->
                      <li class="with-x" v-show="searchParams.props" v-for="(prop,index) in searchParams.props" :key ='index'>
                ...
                <SearchSelector :attrsList='attrsList' :trademarkList='trademarkList' @trademarkInfo = 'trademarkInfo' @attrValueInfo = 'attrValueInfo'/>
                ...
                >
                  ...
                  <div class="operate">
                    ...
                    <Pagination :pageNo='searchParams.pageNo' :pageSize='searchParams.pageSize' :total='total' :pagerCount='5' @currentPage="currentPage"/>
                </div>
...
export default {
    ...
    data(){
      return{
        searchParams:{
            ...
            props: [], //商品属性的搜索条件
            trademark: "", //品牌的搜索条件
            order: "2:desc", //排序的参数 【默认初始值:1:desc】
    ...
    methods: {
      ...
      trademarkInfo(trademark){       
         //console.log("Employee组件监听demo，接收数据：",trademark);
         //this.searchParams.trademark=trademark.tmName;
         this.searchParams.trademark = `${trademark.tmId}:${trademark.tmName}`;
         this.getData();
         //console.log("Employee组件监听demo，接收数据222：",this.searchParams.trademark);
