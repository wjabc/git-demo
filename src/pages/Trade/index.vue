...
import {mapState} from 'vuex'
  export default {
    ...
    mounted(){
      ...
      //console.log('defaultUser:',this.defaultUser)
      //console.log('tradeInfo:',this.tradeInfo)
      //this.defaultUser = this.$store.state.trade.AddressInfo.find(item =>item.isDefault == "1")||{}
    ...
    computed:{
			...
			...mapState({
        // address:(state)=>{return state.trade.AddressInfo}
        address: (state) => state.trade.AddressInfo || [],
        tradeInfo: (state) => state.trade.ShopInfo,
      ...
      // defaultUser(){
      //   let that = this
      //   let obj = that.address.find(item => item.isDefault == "1")
      //    console.log('defaultUser-obj::',obj)
      //   return obj       
      // },
